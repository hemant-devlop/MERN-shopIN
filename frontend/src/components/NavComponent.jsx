...
const NavComponent = () => {
    ...
    const handleLogout = () => {
        ...
        axios.post("http://localhost:8000/api/users/logout", {}, { withCredentials: true }).then(() => {
            // Clear user session or token here
                    ...
                    <div
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions">
                                <NavLink className="btn btn-primary btn-block" to="/cart"><button >View cart</button></NavLink>
                            </div>
                        </div>
                    </div>
                </div>
